              ...
              <ul class="nav nav-pills nav-sidebar flex-column nav-balance" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview">
                  ...
                  <ul class="nav nav-treeview" style="display: none;">
                    <li class="nav-item cubecoin">
                      <script>
                        jQuery(document).ready(function(){
                          ...
                          data: {wallet_address : "{{Auth::user()->wallet_address}}"},
                    ...
                    <li class ="nav-item energon">
                      <script>
                        jQuery(document).ready(function(){
                          $.ajax({
                          type: 'GET',
                          url: "{{route('getEnergonBalance')}}",
                          success: function(data) {
                          $('.energon').append("Your current energon balance <br/> is : " + data.success);
                          },
                          error: function(data){
                          toastr.error('Your balance is negative!!', 'Inconceivable!', {timeOut: 5000});
                          }
                          });
                        });
                      </script>
                    <li class ="nav-item credits">
                      <script>
                        jQuery(document).ready(function(){
                          $.ajax({
                          type: 'GET',
                          url: "{{route('getCreditsBalance')}}",
                          success: function(data) {
                          $('.credits').append("Your current credits balance <br/> is : " + data.success);
                          },
                          error: function(data){
                          toastr.error('Your credits balance is negative!!', 'Inconceivable!', {timeOut: 5000});
                          }
                          });
                        });
                      </script>
