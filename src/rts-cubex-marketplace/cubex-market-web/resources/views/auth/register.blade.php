                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <p><small>&bull; Password must be 6 characters</small></p>
                                <p><small>&bull; Use special characters (@$!%*#?&.,)</small></p>
                                <p><small>&bull; At least one number</small></p>
                                <p><small>&bull; Use both upper and lower case letters</small></p>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <p>It may take up to 20 seconds to register your user in the NEM blockhain</p>
                        </div>
                    </form>
                </div>
            </div>
